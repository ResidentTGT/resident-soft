...
export const shapeActions: ActionsGroup = {
	...
	actions: [
		...
		{ action: ActionName.Bubbles, isolated: true, allowed: true, name: 'Mint Bubbles' },
		{ action: ActionName.OtomMineAllOtoms, isolated: true, allowed: true, name: 'Минтить все уникальные атомы' },
		{ action: ActionName.OtomMineAllIsotopes, isolated: true, allowed: true, name: 'Минтить все изотопы' },
		{ action: ActionName.Spin, isolated: true, allowed: false, name: 'Спин' },
		...
		{ action: ActionName.ParseIsotopes, isolated: false, allowed: false, name: 'Спарсить все изотопы' },
	],
};
